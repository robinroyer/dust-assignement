"""In-memory implementation of AbstractDataSource for integration tests."""
...
class InMemoryDataSource(AbstractDataSource):
    ...
    def list_data_sources(self, space_id: str) -> List[DataSource]:
        return [deepcopy(ds) for (sid, _), ds in self._data_sources.items() if sid == space_id]
    ...
    def list_documents(
        ...
        *,
        ...
        docs = [doc for (sid, did, _), doc in self._documents.items() if sid == space_id and did == ds_id]
